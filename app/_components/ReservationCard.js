    ...
    <div className="flex flex-col sm:flex-row border border-primary-800 rounded-lg overflow-hidden">
      ...
      <div className="flex-grow px-4 sm:px-6 py-3 flex flex-col">
        <div className="flex items-center justify-between">
          ...
          {isPast(new Date(startDate)) ? (
            <span className="bg-yellow-800 text-yellow-200 h-6 sm:h-7 px-2 sm:px-3 uppercase text-xs font-bold flex items-center rounded-sm">
              past
            </span>
          ) : (
            <span className="bg-green-800 text-green-200 h-6 sm:h-7 px-2 sm:px-3 uppercase text-xs font-bold flex items-center rounded-sm">
              upcoming
            </span>
          )}
        </div>
        ...
        <div className="flex flex-wrap gap-3 sm:gap-5 mt-auto items-baseline">
          ...
          <p className="w-full sm:w-auto text-sm text-primary-400">
      ...
      <div className="flex sm:flex-col border-t sm:border-t-0 sm:border-l border-primary-800 w-full sm:w-[100px]">
        <Link
          ...
          className="group flex items-center justify-center sm:justify-start gap-2 uppercase text-xs font-bold text-primary-300 border-b border-primary-800 flex-grow px-3 py-2 sm:py-0 hover:bg-accent-600 transition-colors hover:text-primary-900"
        >
